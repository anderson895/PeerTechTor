...
<?php include "function/PageSpinner.php"; ?>
    ...
    <div class="bg-white shadow-lg rounded-lg w-full max-w-sm p-6">
        ...
        <form id="frmLoginStudent">
            <div class="mb-4">
                <label for="Student_code" class="block text-gray-600 font-medium">Student ID</label>
                <div class="flex items-center border border-gray-300 rounded-md overflow-hidden">
                    <span class="px-3 bg-gray-100 text-gray-500"><i class="bi bi-person"></i></span>
                    <input type="text" id="Student_code" name="Student_code" required placeholder="Enter your Student ID" class="w-full p-2 focus:outline-none">
                </div>
            </div>
            <div class="mb-4">
